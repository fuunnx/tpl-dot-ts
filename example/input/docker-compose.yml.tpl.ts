...
export default stack.compose({
  ...
  services: {
    ...
    ...stack.service('minio', args.isLocal && {
...
function traefikLabels(serviceName: string, options: TraefikLabelsOptions) {
  ...
  return {
    ...
    [`traefik.http.services.${config.prefix}_${args.target}_${serviceName}.loadbalancer.server.port`]: port,
    [`traefik.http.routers.${config.prefix}_${args.target}_${serviceName}-http.entrypoints`]: 'web',
    [`traefik.http.routers.${config.prefix}_${args.target}_${serviceName}-http.middlewares`]: 'https-redirect@file',
    ...
    [`traefik.http.routers.${config.prefix}_${args.target}_${serviceName}.entrypoints`]: 'websecure',
